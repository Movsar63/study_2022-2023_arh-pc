...
author: "Костоев Мовсар НБИбд-02-22"
...
1. Создадим  новый подкаталог с именем lab05 и в нем файл lab5-1.asm. (рис. [-@fig:001])

![Создание файлов в Midnight Commander](image/01.png){ #fig:001 width=70%, height=70% }

2. Введем в файл lab5-1.asm текст программы вывода сообщения на экран и 
